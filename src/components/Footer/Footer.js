            ...
            <Container fluid={true} className="footerBg shadow-lg">
                <Container>
                    <Row>
                        <Col lg={3} md={4} sm={12} className="text-justify">
                            <h4 className="footerTitle">Inteco-Interior</h4>
                ...
                <div className="footer-border py-4 mt-3">
                    <div className="container">
                        <span className="copyright-info">Copyright © 2021 Inteco-Interior. All Rights Reserved.</span>
                        <span className="designer-info">Design & Develop by:</span>
                        <a className="design-by" href="https://devfarshad.com/" target="_blank"> devfarshad</a>
                    </div>
                </div>
            </Container>
        </Fragment>
